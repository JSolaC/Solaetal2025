...
#SBATCH --cpus-per-task=12               # Use 48 CPUs for one task
...
cd /home/codinajs/Models_new/MM_Model_k4_nospat_sigma_unscaled
...
# Run the R script
Rscript MM_Model_IBEX_k4_nospat_sigma_unscaled.R
